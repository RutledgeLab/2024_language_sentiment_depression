...
cur_dir <- '/Users/jihyunhur/Yale/2_Github/project_NLP_depression/2_scripts'
dat_dir <- '/Users/jihyunhur/Yale/2_Github/project_NLP_depression/1_data'
dir_save <- '/Users/jihyunhur/Yale/2_Github/project_NLP_depression/2_scripts/figures'

dat <- read.csv(file.path(dat_dir,'project_NLP_depression_data.csv'))
...
```{r ms 4, echo=TRUE}
## Study 1
cor.test(study1_data$phq, study1_data$phq_2)

## Study 2
cor.test(study2_data$phq, study2_data$phq_2)
```
